...
(ui_table, ui_table_row, ui_row_caption, ui_row_db_scenarios_view_column)
VALUES
('features', 'fuels', 'Fuels', 'feature_fuels'),
('features', 'transmission', 'Transmission', 'feature_transmission'),
('features', 'transmission_hurdle_rates', 'Transmission Hurdle Rates',
'feature_transmission_hurdle_rates'),
('features', 'transmission_sim_flow', 'Transmission Simultaneous Flow Limits',
'feature_simultaneous_flow_limits'),
('features', 'load_following_up', 'Load-Following Reserves Up',
'feature_load_following_up'),
('features', 'load_following_up', 'Load-Following Reserves Down', 'feature_load_following_down'),
('features', 'regulation_up', 'Regulation Reserves Up',
'feature_regulation_up'),
('features', 'regulation_down', 'Regulation Reserves Down',
'feature_regulation_down'),
('features', 'spinning_reserves', 'Spinning Reserves',
'feature_spinning_reserves'),
('features', 'frequency_response', 'Frequency Response Reserves',
'feature_frequency_response'),
('features', 'rps', 'Renewable Portfolio Standard (RPS)', 'feature_rps'),
('features', 'carbon_cap', 'Carbon Cap', 'feature_carbon_cap'),
('features', 'track_carbon_imports', 'Track Carbon Imports',
'feature_track_carbon_imports'),
('features', 'prm', 'Planning Reserve Margin (PRM)', 'feature_prm'),
('features', 'elcc_surface', 'PRM ELCC Surface', 'feature_elcc_surface'),
('features', 'local_capacity', 'Local Capacity Requirement',
'feature_local_capacity');

-- UI scenario detail 'Temporal Settings' table
INSERT INTO ui_scenario_detail_table_metadata
(ui_table, ui_table_caption)
VALUES
('temporal', 'Temporal Settings');

INSERT INTO ui_scenario_detail_table_row_metadata
(ui_table, ui_table_row, ui_row_caption, ui_row_db_scenarios_view_column,
ui_row_db_subscenario_table, ui_row_db_subscenario_table_id_column,
ui_row_db_input_table)
VALUES
('temporal', 'temporal', 'Temporal Span and Resolution', 'temporal',
'subscenarios_temporal', 'temporal_scenario_id', 'inputs_temporal_timepoints');

-- UI scenario detail 'Load Zone Settings' table
INSERT INTO ui_scenario_detail_structure
(ui_table_caption, ui_row_name, ui_row_db_scenarios_view_column,
ui_row_db_subscenarios_table, ui_row_db_subscenarios_table_id_column,
ui_row_db_input_table)
VALUES
('Load Zone Settings', 'Load Zones', 'geography_load_zones',
'subscenarios_geography_load_zones',
'load_zone_scenario_id', 'inputs_geography_load_zones'),
('Load Zone Settings', 'Project Load Zones', 'project_load_zones',
'subscenarios_project_load_zones',
'project_load_zone_scenario_id', 'inputs_project_load_zones'),
('Load Zone Settings', 'Transmission Load Zones', 'transmission_load_zones',
'subscenarios_transmission_load_zones',
'transmission_load_zone_scenario_id', 'inputs_transmission_load_zones');

-- UI scenario detail 'System Load' table
INSERT INTO ui_scenario_detail_structure
(ui_table_caption, ui_row_name, ui_row_db_scenarios_view_column,
ui_row_db_subscenarios_table, ui_row_db_subscenarios_table_id_column,
ui_row_db_input_table)
VALUES
('System Load', 'System Load', 'load_profile',
'subscenarios_system_load', 'load_scenario_id', 'inputs_system_load');

-- UI scenario detail 'Project Capacity' table
