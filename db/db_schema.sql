...
-- DROP TABLE IF EXISTS inputs_temporal_horizon_durations;
-- CREATE TABLE inputs_temporal_horizon_durations (
-- horizon_type VARCHAR(64) PRIMARY KEY
-- );
...
temporal_scenario_id INTEGER,
subproblem_id INTEGER,
horizon_type VARCHAR(64),
horizon INTEGER,
period INTEGER,
boundary VARCHAR(16),
PRIMARY KEY (temporal_scenario_id, subproblem_id, horizon_type, horizon),
FOREIGN KEY (temporal_scenario_id) REFERENCES subscenarios_temporal
(temporal_scenario_id),
...
FOREIGN KEY (temporal_scenario_id, subproblem_id, horizon_type, horizon)
