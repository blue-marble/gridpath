...
# TODO: change this to use more flexible create_scenario function
def load_scenarios_from_csv(io, c, data_input):
    """
    scenario dictionary
    ...
    for sc in data_input.columns.to_list()[1:]:
        scenarios = data_input.set_index(
            'optional_feature_or_subscenarios'
        )[sc].to_dict()

        create_scenario_all_args(
            io=io, c=c,
            scenario_name=sc,
