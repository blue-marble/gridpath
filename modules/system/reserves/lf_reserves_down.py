...
def add_model_components(m, d, scenario_directory, horizon, stage):
    ...
    add_generic_reserve_components(
        m,
        d,
        reserve_zone_param="lf_reserves_down_zone",
        reserve_zone_timepoint_set="LF_RESERVE_DOWN_ZONE_TIMEPOINTS",
        ...
        reserve_generator_set="LF_RESERVES_DOWN_PROJECTS",
...
def load_model_data(m, data_portal, scenario_directory, horizon, stage):
    data_portal.load(filename=os.path.join(scenario_directory, horizon, stage,
                     ...
                     index=m.LF_RESERVE_DOWN_ZONE_TIMEPOINTS,
