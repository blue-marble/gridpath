...
def add_model_components(
    ...
    m.water_system_balancing_type = Param(within=m.BLN_TYPES)
...
def write_model_inputs(
    ...
    water_system_params = get_inputs_from_database(
        scenario_id,
        subscenarios,
        db_weather_iteration,
        db_hydro_iteration,
    ...
    with open(
        ...
        for row in water_system_params:
            writer.writerow(row)
