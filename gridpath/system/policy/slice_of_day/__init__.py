...
SLICE_OF_DAY_ZONE_PRD_MONTH_HOUR_DF = "slice_of_day_zone_period_month_hour_df"
...
def export_results(
    ...
    # The results dataframe is indexed by (slice_of_day_zone, period, month, hour)

    z_prd_mn_hr_df = pd.DataFrame(
        columns=[
            "slice_of_day_zone",
            "period",
            "month",
    ...
    setattr(d, SLICE_OF_DAY_ZONE_PRD_MONTH_HOUR_DF, z_prd_mn_hr_df)
...
def import_results_into_database(
    ...
    import_csv(
        ...
        which_results="system_slice_of_day",
    )
