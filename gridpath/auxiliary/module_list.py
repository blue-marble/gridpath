...
def all_modules_list():
    ...
    all_modules = [
        ...
        "system.policy.slice_of_day",
        "system.policy.slice_of_day.slice_of_day_target",
        "project.policy.slice_of_day_storage",
        "system.policy.slice_of_day.aggregate_slice_of_day_contributions",
        "system.policy.slice_of_day.slice_of_day_balance",
        "system.policy.slice_of_day.consolidate_results",
