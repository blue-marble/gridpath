...
RESERVE_PROVISION_RAMP_RATE_LIMIT_COLUMN_NAME_IN_INPUT_FILE = (
    "lf_reserves_down_ramp_rate_limit"
)
# Model components
RESERVE_PROVISION_VARIABLE_NAME = "Provide_LF_Reserves_Down_MW"
RESERVE_PROVISION_RAMP_RATE_LIMIT_CONSTRAINT_NAME = (
    "LF_Reserves_Down_Provision_Ramp_Rate_Limit_Constraint"
)
RESERVE_PROVISION_RAMP_RATE_LIMIT_PARAM_NAME = "lf_reserves_down_ramp_rate_limit"
...
def get_inputs_from_database(
    ...
    prj_ramp_rates = c.execute(
        """SELECT project, lf_reserves_down_ramp_rate
