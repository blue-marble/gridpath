...
RESERVE_BALANCING_AREAS_INPUT_FILE_NAME = "regulation_down_balancing_areas.tab"
# Model components
RESERVE_PROVISION_VARIABLE_NAME = "Provide_Regulation_Down_MW"
RESERVE_PROVISION_DERATE_PARAM_NAME = "regulation_down_derate"
RESERVE_TO_ENERGY_ADJUSTMENT_PARAM_NAME = "regulation_down_reserve_to_energy_adjustment"
...
def record_dynamic_components(
    d, scenario_directory, weather_iteration, hydro_iteration, subproblem, stage
):
    """
...
def get_inputs_from_database(
    ...
    project_bas, prj_derates = generic_get_inputs_from_database(
        ...
        project_ba_subscenario_id=subscenarios.PROJECT_REGULATION_DOWN_BA_SCENARIO_ID,
        ba_subscenario_id=subscenarios.REGULATION_DOWN_BA_SCENARIO_ID,
    )
