...
def add_module_specific_components(m, d):
    ...
    *DISPATCHABLE_CONTINUOUS_COMMIT_GENERATOR_OPERATIONAL_TIMEPOINTS* (
    ...
    Commit_Continuous is the continuous commit variable to represent 'on' or
    'off' state of a generator. It is defined over over
    *DISPATCHABLE_CONTINUOUS_COMMIT_GENERATOR_OPERATIONAL_TIMEPOINTS*.
    Provide_Power_DispContinuousCommit_MW is the power provision variable for
    the generator. It is defined over
    *DISPATCHABLE_CONTINUOUS_COMMIT_GENERATOR_OPERATIONAL_TIMEPOINTS*.
    ...
    def min_up_time_constraint_rule(mod, g, tmp):
        ...
        will already properly constrain the continuous start variables of the
        first timepoints before it.
    ...
    def min_down_time_constraint_rule(mod, g, tmp):
        ...
        Constraint (7) from Morales-Espana et al. (2013).
        Example 1:
