...
#     m.STARTUP_BY_ST_PRJS_TYPES = Set(dimen=2, ordered=True)
#     m.STARTUP_BY_ST_PRJS = Set(
#         initialize=lambda mod: sorted(list(set([p for (p, t) in
#                                           mod.STARTUP_BY_ST_PRJS_TYPES])))
#     )
#
#     # All startup cost projects
#     m.STARTUP_COST_PRJS = Set(
...
#     m.FUEL_PRJS = Set(
#         within=m.PROJECTS,
#         initialize=lambda mod: sorted(list(set([prj for (prj, f) in
#                                           mod.FUEL_PRJ_FUELS]))),
#     )
#     m.FUELS_BY_PRJ = Set(
#         m.FUEL_PRJS,
#         within=m.FUELS,
#         initialize=lambda mod, prj: sorted([f for (p, f) in mod.FUEL_PRJ_FUELS \
#             if p == prj]),
#     )
#
#     m.FUEL_PRJ_FUELS_FUEL_GROUP = Set(
