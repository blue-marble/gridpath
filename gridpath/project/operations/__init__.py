...
def add_model_components(m, d, scenario_directory, subproblem, stage):
    ...
    +-------------------------------------------------------------------------+
    | | :code:`SOC_PENALTY_COST_LAST_TMP_PRJS`                                |
    | | *Within*: :code:`PROJECTS`                                            |
    |                                                                         |
    | The set of projects that incur cost if their state of charge is below   |
    ...
    | | *Defined over*: :code:`SOC_PENALTY_COST_LAST_TMP_PRJS`                |
    | | *Within*: :code:`NonNegativeReals`                                    |
    |                                                                         |
    | The project's cost per unit of energy below the maximum state of charge |
    ...
    m.SOC_PENALTY_COST_LAST_TMP_PRJS = Set(within=m.PROJECTS)
    ...
    m.soc_last_tmp_penalty_cost_per_energyunit = Param(
        m.SOC_PENALTY_COST_LAST_TMP_PRJS, within=NonNegativeReals
    )
...
def load_model_data(m, d, data_portal, scenario_directory, subproblem, stage):
    ...
    data_portal.data()["SOC_PENALTY_COST_LAST_TMP_PRJS"] = {
        None: list(
