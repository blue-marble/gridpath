...
def add_model_components(m, d, scenario_directory, subproblem, stage):
    ...
    | | :code:`NEW_LIN`                                                  |
    |                                                                         |
    | The list of projects of capacity type :code:`new_lin`.             |
    +-------------------------------------------------------------------------+
    | | :code:`NEW_LIN_VNTS`                                             |
    |                                                                         |
    ...
    | optimization.                                                           |
    +-------------------------------------------------------------------------+
    | | :code:`NEW_LIN_VNTS_W_MIN_CAPACITY_CONSTRAINT`                   |
    |                                                                         |
    ...
    +-------------------------------------------------------------------------+
    | | :code:`NEW_LIN_VNTS_W_MIN_ENERGY_CONSTRAINT`                     |
    |                                                                         |
    | Two-dimensional set of project-vintage combinations to describe all     |
    | possible project-vintage combinations for projects with a cumulative    |
    | minimum build energy specified.                                         |
    +-------------------------------------------------------------------------+
    | | :code:`NEW_LIN_VNTS_W_MAX_CAPACITY_CONSTRAINT`                   |
    |                                                                         |
    | Two-dimensional set of project-vintage combinations to describe all     |
    | possible project-vintage combinations for projects with a cumulative    |
    | maximum build capacity specified.                                       |
    +-------------------------------------------------------------------------+
    | | :code:`NEW_LIN_VNTS_W_MAX_ENERGY_CONSTRAINT`                     |
    |                                                                         |
    | Two-dimensional set of project-vintage combinations to describe all     |
    | possible project-vintage combinations for projects with a cumulative    |
    ...
    | dollars in per MW.                                                      |
    +-------------------------------------------------------------------------+
    | | :code:`new_lin_annualized_real_cost_per_mwh_yr`                  |
    | | *Defined over*: :code:`NEW_LIN_VNTS`                             |
    | | *Within*: :code:`NonNegativeReals`                                    |
    |                                                                         |
    ...
    .. note:: The cost input to the model is a levelized cost per unit
        ...
        :code:`new_lin_lifetime_yrs`,
        :code:`new_lin_annualized_real_cost_per_mw_yr`, and
        :code:`new_lin_annualized_real_cost_per_mwh_yr` parameters are
        consistent.

    +-------------------------------------------------------------------------+
    | Optional Input Params                                                   |
    +=========================================================================+
    | | :code:`new_lin_min_cumulative_new_build_mw`                      |
    | | *Defined over*: :code:`NEW_LIN_VNTS`                             |
    | | *Within*: :code:`NonNegativeReals`                                    |
    |                                                                         |
    ...
    +-------------------------------------------------------------------------+
    | | :code:`new_lin_min_cumulative_new_build_mwh`                     |
    | | *Defined over*: :code:`NEW_LIN_VNTS`                             |
    | | *Within*: :code:`NonNegativeReals`                                    |
    |                                                                         |
    ...
    | built for a storage project by a certain period.                        |
    +-------------------------------------------------------------------------+
    | | :code:`new_lin_max_cumulative_new_build_mw`                      |
    | | *Defined over*: :code:`NEW_LIN_VNTS`                             |
    | | *Within*: :code:`NonNegativeReals`                                    |
    |                                                                         |
    ...
    +-------------------------------------------------------------------------+
    | | :code:`new_lin_max_cumulative_new_build_mwh`                     |
    | | *Defined over*: :code:`NEW_LIN_VNTS`                             |
    | | *Within*: :code:`NonNegativeReals`                                    |
    |                                                                         |
    ...
    | Variables                                                               |
    +=========================================================================+
    | | :code:`NewLin_Build_MW`                                           |
    | | *Defined over*: :code:`NEW_LIN_VNTS`                             |
    | | *Within*: :code:`NonNegativeReals`                                    |
    |                                                                         |
    | Determines how much power capacity (in MW) of each possible vintage is  |
    | built at each new_lin project.                                     |
    +-------------------------------------------------------------------------+
    | | :code:`NewLin_Build_MWh`                                          |
    | | *Defined over*: :code:`NEW_LIN_VNTS`                             |
    | | *Within*: :code:`NonNegativeReals`                                    |
    |                                                                         |
    | Determines how much energy capacity (in MWh) of each possible vintage   |
    | is built at each new_lin project. Note that this is independent    |
    | from :code:`NewLin_Build_MW`, making the storage duration sizing    |
    ...
    | Expressions                                                             |
    +=========================================================================+
    | | :code:`NewLin_Capacity_MW`                                  |
    | | *Defined over*: :code:`NEW_LIN_OPR_PRDS`                         |
    | | *Within*: :code:`NonNegativeReals`                                    |
    |                                                                         |
    ...
    +-------------------------------------------------------------------------+
    | | :code:`NewLin_Energy_Capacity_MWh`                                |
    | | *Defined over*: :code:`NEW_LIN_OPR_PRDS`                         |
    | | *Within*: :code:`NonNegativeReals`                                    |
    |                                                                         |
    ...
    | Constraints                                                             |
    +=========================================================================+
    | | :code:`NewLin_Min_Duration_Constraint`                            |
    | | *Defined over*: :code:`NEW_LIN_OPR_PRDS`                         |
    |                                                                         |
    ...
    | vintage.                                                                |
    +-------------------------------------------------------------------------+
    | | :code:`NewLin_Max_Duration_Constraint`                            |
    | | *Defined over*: :code:`NEW_LIN_OPR_PRDS`                         |
    |                                                                         |
    | Ensures that the storage duration in each operational period is above   |
    | a pre-specified requirement.                                            |
    +-------------------------------------------------------------------------+
    | | :code:`NewLin_Min_Cum_Build_Capacity_Constraint`                  |
    | | *Defined over*: :code:`NEW_LIN_VNTS_W_MIN_CAPACITY_CONSTRAINT`   |
    |                                                                         |
    | Ensures that A certain amount of power capacity is built by a certain   |
    | period, based on :code:`new_lin_min_cumulative_new_build_mw`.      |
    +-------------------------------------------------------------------------+
    | | :code:`NewLin_Min_Cum_Build_Energy_Constraint`                    |
    | | *Defined over*: :code:`NEW_LIN_VNTS_W_MIN_ENERGY_CONSTRAINT`     |
    |                                                                         |
    | Ensures that A certain amount of energy capacity is built by a certain  |
    | period, based on :code:`new_lin_min_cumulative_new_build_mwh`.     |
    +-------------------------------------------------------------------------+
    | | :code:`NewLin_Max_Cum_Build_Capacity_Constraint`                  |
    | | *Defined over*: :code:`NEW_LIN_VNTS_W_MAX_CAPACITY_CONSTRAINT`   |
    |                                                                         |
    | Limits the amount of power capacity built by a certain period, based on |
    | :code:`new_lin_max_cumulative_new_build_mw`.                       |
    +-------------------------------------------------------------------------+
    | | :code:`NewLin_Max_Cum_Build_Energy_Constraint`                    |
    | | *Defined over*: :code:`NEW_LIN_VNTS_W_MAX_ENERGY_CONSTRAINT`     |
    |                                                                         |
    | Limits the amount of energy capacity built by a certain period, based   |
    | on :code:`new_lin_max_cumulative_new_build_mwh`.                   |
    +-------------------------------------------------------------------------+
    ...
    m.NEW_LIN_VNTS = Set(
        dimen=2, within=m.NEW_LIN*m.PERIODS
    )

    m.NEW_LIN_VNTS_W_MIN_CAPACITY_CONSTRAINT = Set(
        dimen=2, within=m.NEW_LIN_VNTS
    )

    m.NEW_LIN_VNTS_W_MIN_ENERGY_CONSTRAINT = Set(
        dimen=2, within=m.NEW_LIN_VNTS
    )

    m.NEW_LIN_VNTS_W_MAX_CAPACITY_CONSTRAINT = Set(
        dimen=2, within=m.NEW_LIN_VNTS
    )

    m.NEW_LIN_VNTS_W_MAX_ENERGY_CONSTRAINT = Set(
        dimen=2, within=m.NEW_LIN_VNTS
    )
    ...
    m.new_lin_lifetime_yrs = Param(
        m.NEW_LIN_VNTS,
        within=NonNegativeReals
    )

    m.new_lin_annualized_real_cost_per_mw_yr = Param(
        m.NEW_LIN_VNTS,
        within=NonNegativeReals
    )

    m.new_lin_annualized_real_cost_per_mwh_yr = Param(
        m.NEW_LIN_VNTS,
        within=NonNegativeReals,
        default=Infinity
    )
    ...
    m.new_lin_min_duration_hrs = Param(
        m.NEW_LIN,
        within=NonNegativeReals,
        default=0
    )

    m.new_lin_max_duration_hrs = Param(
        m.NEW_LIN,
        within=NonNegativeReals,
        default=Infinity
    )

    m.new_lin_min_cumulative_new_build_mw = Param(
        m.NEW_LIN_VNTS_W_MIN_CAPACITY_CONSTRAINT,
        within=NonNegativeReals
    )

    m.new_lin_min_cumulative_new_build_mwh = Param(
        m.NEW_LIN_VNTS_W_MIN_ENERGY_CONSTRAINT,
        within=NonNegativeReals,
        default=0
    )

    m.new_lin_max_cumulative_new_build_mw = Param(
        m.NEW_LIN_VNTS_W_MAX_CAPACITY_CONSTRAINT,
        within=NonNegativeReals
    )

    m.new_lin_max_cumulative_new_build_mwh = Param(
        m.NEW_LIN_VNTS_W_MAX_ENERGY_CONSTRAINT,
        within=NonNegativeReals,
        default=Infinity
    )
    ...
    m.OPR_PRDS_BY_NEW_LIN_VINTAGE = Set(
        m.NEW_LIN_VNTS,
        initialize=operational_periods_by_vintage
    )

    m.NEW_LIN_OPR_PRDS = Set(
        dimen=2,
        initialize=new_lin_operational_periods
    )

    m.NEW_LIN_VNTS_OPR_IN_PRD = Set(
        m.PERIODS, dimen=2,
        initialize=new_lin_vintages_operational_in_period
    )

    # Variable
    ###########################################################################

    m.NewLin_Build_MW = Var(
        m.NEW_LIN_VNTS,
        within=NonNegativeReals
    )

    m.NewLin_Build_MWh = Var(
        m.NEW_LIN_VNTS,
        within=NonNegativeReals
    )
    ...
    m.NewLin_Capacity_MW = Expression(
        m.NEW_LIN_OPR_PRDS,
        rule=power_rule
    )

    m.NewLin_Energy_Capacity_MWh = Expression(
        m.NEW_LIN_OPR_PRDS,
        rule=energy_rule
    )
    ...
    m.NewLin_Min_Duration_Constraint = Constraint(
        m.NEW_LIN_OPR_PRDS,
        rule=min_duration_rule
    )

    # m.NewLin_Max_Duration_Constraint = Constraint(
    #     m.NEW_LIN_OPR_PRDS,
    #     rule=max_duration_rule
    # )

    m.NewLin_Min_Cum_Build_Capacity_Constraint = Constraint(
        m.NEW_LIN_VNTS_W_MIN_CAPACITY_CONSTRAINT,
        rule=min_cum_build_capacity_rule
    )

    m.NewLin_Min_Cum_Build_Energy_Constraint = Constraint(
        m.NEW_LIN_VNTS_W_MIN_ENERGY_CONSTRAINT,
        rule=min_cum_build_energy_rule
    )

    m.NewLin_Max_Cum_Build_Capacity_Constraint = Constraint(
        m.NEW_LIN_VNTS_W_MAX_CAPACITY_CONSTRAINT,
        rule=max_cum_build_capacity_rule
    )

    m.NewLin_Max_Cum_Build_Energy_Constraint = Constraint(
        m.NEW_LIN_VNTS_W_MAX_ENERGY_CONSTRAINT,
...
def operational_periods_by_vintage(mod, prj, v):
    return operational_periods_by_project_vintage(
        ...
        vintage=v,
        lifetime_yrs=mod.new_lin_lifetime_yrs[prj, v])


def new_lin_operational_periods(mod):
    return project_operational_periods(
        project_vintages_set=mod.NEW_LIN_VNTS,
        operational_periods_by_project_vintage_set=
        mod.OPR_PRDS_BY_NEW_LIN_VINTAGE
    )


def new_lin_vintages_operational_in_period(mod, p):
    return project_vintages_operational_in_period(
        project_vintage_set=mod.NEW_LIN_VNTS,
        operational_periods_by_project_vintage_set=
        mod.OPR_PRDS_BY_NEW_LIN_VINTAGE,
        period=p
    )
...
def power_rule(mod, g, p):
    """
    **Expression Name**: NewLin_Capacity_MW
    **Defined Over**: NEW_LIN_OPR_PRDS
    ...
    """
    return sum(mod.NewLin_Build_MW[g, v]
               for (gen, v) in mod.NEW_LIN_VNTS_OPR_IN_PRD[p]
               if gen == g)


def energy_rule(mod, g, p):
    """
    **Expression Name**: NewLin_Energy_Capacity_MWh
    **Defined Over**: NEW_LIN_OPR_PRDS
    ...
    0 for the purposes of the objective function).
    """
    return sum(mod.NewLin_Build_MWh[g, v]
               for (gen, v) in mod.NEW_LIN_VNTS_OPR_IN_PRD[p]
               if gen == g)
...
def min_duration_rule(mod, g, p):
    """
    **Constraint Name**: NewLin_Min_Duration_Constraint
    **Enforced Over**: NEW_LIN_OPR_PRDS

    age duration must be above a pre-specified requirement in each
    operational period.
    """
    if mod.new_lin_min_duration_hrs == 0:
        return Constraint.Skip
    else:
        return mod.NewLin_Energy_Capacity_MWh[g, p] \
            >= mod.NewLin_Capacity_MW[g, p] \
            * mod.new_lin_min_duration_hrs[g]


def max_duration_rule(mod, g, p):
    """
    **Constraint Name**: NewLin_Max_Duration_Constraint
    **Enforced Over**: NEW_LIN_OPR_PRDS

    age duration must be below a pre-specified requirement in each
    operational period.
    """
    if mod.new_lin_min_duration_hrs == Infinity:
        return Constraint.Skip
    else:
        return mod.NewLin_Energy_Capacity_MWh[g, p] \
            <= mod.NewLin_Capacity_MW[g, p] \
            * mod.new_lin_max_duration_hrs[g]


def min_cum_build_capacity_rule(mod, g, p):
    """
    **Constraint Name**: NewLin_Min_Cum_Build_Capacity_Constraint
    **Enforced Over**: NEW_LIN_VNTS_W_MIN_CAPACITY_CONSTRAINT

    Must build a certain amount of power capacity by period p.
    """
    if mod.new_lin_min_cumulative_new_build_mw == 0:
        return Constraint.Skip
    else:
        return mod.NewLin_Capacity_MW[g, p] \
            >= mod.new_lin_min_cumulative_new_build_mw[g, p]


def min_cum_build_energy_rule(mod, g, p):
    """
    **Constraint Name**: NewLin_Min_Cum_Build_Energy_Constraint
    **Enforced Over**: NEW_LIN_VNTS_W_MIN_ENERGY_CONSTRAINT

    Must build a certain amount of energy capacity by period p.
    """
    if mod.new_lin_min_cumulative_new_build_mwh == 0:
        return Constraint.Skip
    else:
        return mod.NewLin_Energy_Capacity_MWh[g, p] \
            >= mod.new_lin_min_cumulative_new_build_mwh[g, p]


def max_cum_build_capacity_rule(mod, g, p):
    """
    **Constraint Name**: NewLin_Max_Cum_Build_Capacity_Constraint
    **Enforced Over**: NEW_LIN_VNTS_W_MAX_CAPACITY_CONSTRAINT

    Can't build more than certain amount of power capacity by period p.
    """
    if mod.new_lin_min_cumulative_new_build_mw == Infinity:
        return Constraint.Skip
    else:
        return mod.NewLin_Capacity_MW[g, p] \
            <= mod.new_lin_max_cumulative_new_build_mw[g, p]


def max_cum_build_energy_rule(mod, g, p):
    """
    **Constraint Name**: NewLin_Max_Cum_Build_Energy_Constraint
    **Enforced Over**: NEW_LIN_VNTS_W_MAX_ENERGY_CONSTRAINT

    Can't build more than certain amount of energy capacity by period p.
    """
    if mod.new_lin_max_cumulative_new_build_mwh == Infinity:
        return Constraint.Skip
    else:
        return mod.NewLin_Energy_Capacity_MWh[g, p] \
            <= mod.new_lin_max_cumulative_new_build_mwh[g, p]
...
def capacity_cost_rule(mod, g, p):
    ...
    """
    return sum((mod.NewLin_Build_MW[g, v]
                * mod.new_lin_annualized_real_cost_per_mw_yr[g, v]
                # + mod.NewLin_Build_MWh[g, v]
                # * mod.new_lin_annualized_real_cost_per_mwh_yr[g, v]
                )
               for (gen, v) in mod.NEW_LIN_VNTS_OPR_IN_PRD[p]
               if gen == g)
...
def new_capacity_rule(mod, g, p):
    ...
    """
    return mod.NewLin_Build_MW[g, p] \
        if (g, p) in mod.NEW_LIN_VNTS else 0
...
def load_model_data(
    ...
    def get_data():
        ...
        for r in zip(_df["project"],
            ...
            if r[1] == "new_lin":
                new_lin_projects.append(r[0])
                if r[2] == ".":
                    pass
                else:
                    min_duration[r[0]] = float(r[2])
                if r[3] == ".":
                    pass
                else:
                    max_duration[r[0]] = float(r[3])
            else:
                pass

        return new_lin_projects, min_duration, max_duration

    new_lin_set, new_lin_min_duration_hrs, \
        new_lin_max_duration_hrs = get_data()
    data_portal.data()["NEW_LIN"] = \
        {None: new_lin_set}
    data_portal.data()["new_lin_min_duration_hrs"] = \
        new_lin_min_duration_hrs
    data_portal.data()["new_lin_max_duration_hrs"] = \
        new_lin_max_duration_hrs

    # TODO: throw an error when a project of the 'new_lin' capacity
    #   type is not found in new_build_vintage_costs.tab
    data_portal.load(
        filename=os.path.join(scenario_directory, str(subproblem), str(stage),
                              "inputs", "new_build_vintage_costs.tab"),
        index=m.NEW_LIN_VNTS,
        select=("project", "vintage", "lifetime_yrs",
                "annualized_real_cost_per_mw_yr",
                "annualized_real_cost_per_mwh_yr"),
        param=(m.new_lin_lifetime_yrs,
               m.new_lin_annualized_real_cost_per_mw_yr,
               m.new_lin_annualized_real_cost_per_mwh_yr)
        )
    ...
    # new_lin_min_cumulative_new_build_mw and
    # new_lin_min_cumulative_new_build_mwh are optional,
    # so NEW_LIN_VNTS_WITH_MIN_CONSTRAINT
    ...
    if not project_vintages_with_min_capacity:
        ...
        data_portal.data()["NEW_LIN_VNTS_W_MIN_CAPACITY_CONSTRAINT"] =\
            {None: project_vintages_with_min_capacity}
    data_portal.data()["new_lin_min_cumulative_new_build_mw"] = \
        min_cumulative_mw

    if not project_vintages_with_min_energy:
        pass  # if the list is empty, don't initialize the set
    else:
        data_portal.data()["NEW_LIN_VNTS_W_MIN_ENERGY_CONSTRAINT"] = \
            {None: project_vintages_with_min_energy}
    data_portal.data()["new_lin_min_cumulative_new_build_mwh"] = \
        min_cumulative_mwh

    if not project_vintages_with_max_capacity:
        pass  # if the list is empty, don't initialize the set
    else:
        data_portal.data()["NEW_LIN_VNTS_W_MAX_CAPACITY_CONSTRAINT"] =\
            {None: project_vintages_with_max_capacity}
    data_portal.data()["new_lin_max_cumulative_new_build_mw"] = \
        max_cumulative_mw

    if not project_vintages_with_max_energy:
        pass  # if the list is empty, don't initialize the set
    else:
        data_portal.data()["NEW_LIN_VNTS_W_MAX_ENERGY_CONSTRAINT"] = \
            {None: project_vintages_with_max_energy}
    data_portal.data()["new_lin_max_cumulative_new_build_mwh"] = \
        max_cumulative_mwh
...
def export_results(
    ...
    with open(os.path.join(scenario_directory, str(subproblem), str(stage), "results",
                           "capacity_new_lin.csv"), "w", newline="") as f:
        writer = csv.writer(f)
        writer.writerow(["project", "vintage", "technology", "load_zone",
                         "new_build_mw", "new_build_mwh"])
        for (prj, v) in m.NEW_LIN_VNTS:
            writer.writerow([
                prj,
                v,
                m.technology[prj],
                m.load_zone[prj],
                value(m.NewLin_Build_MW[prj, v]),
                0
                # value(m.NewLin_Build_MWh[prj, v])
            ])
...
def summarize_results(
    ...
    new_build_df.columns = [
        "New Power Capacity ({})".format(power_unit),
        "New Energy Capacity ({})".format(energy_unit)
    ]

    with open(summary_results_file, "a") as outfile:
        outfile.write("\n--> New Capacity <--\n")
        if new_build_df.empty:
            outfile.write("No new capacity was built.\n")
        else:
...
def get_model_inputs_from_database(
    ...
    new_costs = c.execute(
        ...
        AND capacity_type = 'new_lin') as new_lin_portfolio """.format(
...
def write_model_inputs(
    ...
    new_build_vintage_costs.tab file
    ...
    new_costs = get_model_inputs_from_database(
        scenario_id, subscenarios, subproblem, stage, conn
    )
...
def validate_inputs(scenario_id, subscenarios, subproblem, stage, conn):
    ...
    projects = get_projects(conn, scenario_id, subscenarios, "capacity_type", "new_lin")

    # Convert input data into pandas DataFrame
    cost_df = cursor_to_df(new_costs)
