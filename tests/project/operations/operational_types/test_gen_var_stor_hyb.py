...
NAME_OF_MODULE_BEING_TESTED = \
    "project.operations.operational_types.gen_var_stor_hyb"
...
class TestGenVarStorHybOpType(unittest.TestCase):
    ...
    def test_data_loaded_correctly(self):
        ...
        actual_gen_set = sorted([
            prj for prj in instance.GEN_VAR_STOR_HYB
            ])
        ...
        expected_ch_eff = OrderedDict(
            sorted({"Wind_Battery_Hybrid": 0.8}.items())
        )
        ...
        expected_disch_eff = OrderedDict(
            sorted({"Wind_Battery_Hybrid": 0.8}.items())
        )
