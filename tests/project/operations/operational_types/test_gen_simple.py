...
NAME_OF_MODULE_BEING_TESTED = "project.operations.operational_types.gen_simple"
...
class TestGenSimple(unittest.TestCase):
    ...
    def test_data_loaded_correctly(self):
        ...
        actual_disp_no_commit_gen_set = sorted([prj for prj in instance.GEN_SIMPLE])
        self.assertListEqual(
            expected_disp_no_commit_gen_set, actual_disp_no_commit_gen_set
        )

        # Set: GEN_SIMPLE_OPR_TMPS
        expected_operational_timpoints_by_project = sorted(
            get_project_operational_timepoints(expected_disp_no_commit_gen_set)
        )
        ...
        expected_ramp_down_when_on_rate = {"Disp_No_Commit": 1}  # default value
        actual_ramp_down_when_on_rate = {
