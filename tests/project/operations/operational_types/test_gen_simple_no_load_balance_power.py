...
NAME_OF_MODULE_BEING_TESTED = (
    "project.operations.operational_types.gen_simple_no_load_balance_power"
)
...
class TestGenSimpleNoLoadBalancePower(unittest.TestCase):
    """ """
    ...
    def test_data_loaded_correctly(self):
        ...
        # Set: GEN_SIMPLE_NO_LOAD_BALANCE_POWER
        expected_gen_must_run_gen_set = sorted(["Gen_Simple_No_Load_Balance_Power"])
        actual_gen_must_run_gen_set = sorted(
            [prj for prj in instance.GEN_SIMPLE_NO_LOAD_BALANCE_POWER]
        )
        self.assertListEqual(expected_gen_must_run_gen_set, actual_gen_must_run_gen_set)

        # Set: GEN_SIMPLE_NO_LOAD_BALANCE_POWER_OPR_TMPS
        ...
        actual_operational_timepoints_by_project = sorted(
            [
                (g, tmp)
                for (g, tmp) in instance.GEN_SIMPLE_NO_LOAD_BALANCE_POWER_OPR_TMPS
            ]
        )
