...
class TestGenAlwaysOn(unittest.TestCase):
    ...
    def test_data_loaded_correctly(self):
        ...
        actual_tmps_by_fuel_project = sorted([
            ...
            instance.GEN_ALWAYS_ON_FUEL_PRJS_OPR_TMPS
                                                 ])
        self.assertListEqual(expected_tmps_by_fuel_project,
                             actual_tmps_by_fuel_project)

        # Set: GEN_ALWAYS_ON_FUEL_PRJS_PRDS_SGMS
        ...
        actual_fuel_project_segments_operational_timepoints = sorted([
            ...
            instance.GEN_ALWAYS_ON_FUEL_PRJS_OPR_TMPS_SGMS
        ])
        ...
        # Param: gen_always_on_fuel_burn_slope_mmbtu_per_mwh
        ...
        actual_fuel_burn_slope = OrderedDict(sorted(
            {(prj, p, s):
                 instance.gen_always_on_fuel_burn_slope_mmbtu_per_mwh[(prj,
                                                                        p, s)]
             for (prj, p, s) in 
             instance.GEN_ALWAYS_ON_FUEL_PRJS_PRDS_SGMS}.items()
            )
        )
        ...
        # Param: gen_always_on_fuel_burn_intercept_mmbtu_per_mw_hour
        ...
        actual_fuel_burn_intercept = OrderedDict(sorted(
            {(prj, p, s):
                 instance.gen_always_on_fuel_burn_intercept_mmbtu_per_mw_hr[
                (prj, p, s)]
             for (prj, p, s) in instance.GEN_ALWAYS_ON_FUEL_PRJS_PRDS_SGMS}.items()
            )
        )
