...
NAME_OF_MODULE_BEING_TESTED = "project.operations.operational_types.gen_var_must_take"
...
class TestGenVarMustTake(unittest.TestCase):
    """ """
    ...
    def test_data_loaded_correctly(self):
        ...
        expected_gen_set = sorted(["Customer_PV"])
        actual_gen_set = sorted([prj for prj in instance.GEN_VAR_MUST_TAKE])
        ...
        actual_operational_timepoints_by_project = sorted(
            [(g, tmp) for (g, tmp) in instance.GEN_VAR_MUST_TAKE_OPR_TMPS]
        )
        ...
        actual_cap_factor = {
            ...
            for (g, tmp) in instance.GEN_VAR_MUST_TAKE_OPR_TMPS
        }
