...
NAME_OF_MODULE_BEING_TESTED = "project.operations.reserves.regulation_up"
...
class TestRegulationUpProvision(unittest.TestCase):
    ...
    def test_data_loaded_correctly(self):
        ...
        actual_projects = sorted([prj for prj in instance.REGULATION_UP_PROJECTS])
        ...
        expected_adjustment = OrderedDict(sorted({"Zone1": 0, "Zone2": 0}.items()))
        actual_adjustment = OrderedDict(
            sorted(
                {
                    z: instance.regulation_up_reserve_to_energy_adjustment[z]
