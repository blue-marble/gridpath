    ...
    def test_data_loaded_correctly(self):
        ...
        actual_reserves_zone = OrderedDict(sorted(
            {prj: instance.frequency_response_ba[prj]
             for prj in instance.FREQUENCY_RESPONSE_PROJECTS}.items()
        )
        )
        ...
        actual_adjustment = OrderedDict(sorted(
            {z: instance.
                frequency_response_reserve_to_energy_adjustment[z]
