...
PREREQUISITE_MODULE_NAMES = [
    ...
    "geography.regulation_down_balancing_areas", "project",
...
class TestRegulationDownProvision(unittest.TestCase):
    ...
    def test_data_loaded_correctly(self):
        ...
        actual_projects = sorted([
            prj for prj in instance.REGULATION_DOWN_PROJECTS
        ])
        ...
        expected_reserves_zone = OrderedDict(sorted(
            {"Gas_CCGT": "Zone1", "Coal": "Zone1", "Gas_CCGT_New": "Zone1",
             ...
             "Gas_CCGT_z2": "Zone2", "Coal_z2": "Zone2",
        ...
        actual_reserves_zone = OrderedDict(sorted(
            {prj: instance.regulation_down_zone[prj]
             for prj in instance.REGULATION_DOWN_PROJECTS}.items()
        )
        )
        self.assertDictEqual(expected_reserves_zone, actual_reserves_zone)

        # Set: REGULATION_DOWN_PROJECT_OPERATIONAL_TIMEPOINTS
        ...
        actual_prj_op_tmps = sorted([
            ...
            instance.REGULATION_DOWN_PROJECT_OPERATIONAL_TIMEPOINTS
        ])
        ...
        actual_adjustment = OrderedDict(sorted(
            {z: instance.
                regulation_down_reserve_to_energy_adjustment[z]
