...
NAME_OF_MODULE_BEING_TESTED = "project.operations.reserves.lf_reserves_up"
...
class TestLFReservesUpProvision(unittest.TestCase):
    ...
    def test_data_loaded_correctly(self):
        ...
        actual_projects = sorted([prj for prj in instance.LF_RESERVES_UP_PROJECTS])
        ...
        actual_prj_op_tmps = sorted(
            [(prj, tmp) for (prj, tmp) in instance.LF_RESERVES_UP_PRJ_OPR_TMPS]
        )
        ...
        actual_adjustment = OrderedDict(
            sorted(
                {
                    z: instance.lf_reserves_up_reserve_to_energy_adjustment[z]
