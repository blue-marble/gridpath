...
NAME_OF_MODULE_BEING_TESTED = "project.reliability.prm.prm_types.energy_only_allowed"
...
class TestProjPRMTypeFullyDeliverable(unittest.TestCase):
    ...
    def test_data_loaded_correctly(self):
        ...
        expected_projects = sorted(["Wind", "Wind_z2"])
        actual_projects = sorted([prj for prj in instance.EOA_PRM_PROJECTS])
