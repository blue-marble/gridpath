...
class TestCapacityGroups(unittest.TestCase):
    ...
    def test_initialized_components(self):
        ...
        actual_cap_group_periods = sorted(
            [(prj, period)
             for (prj, period) in instance.CAPACITY_GROUP_PERIODS
             ]
        )
        self.assertListEqual(expected_cap_group_periods,
                             actual_cap_group_periods)
        ...
        actual_cap_group_periods = sorted(
            [g for g in instance.CAPACITY_GROUPS]
        )
        self.assertListEqual(expected_cap_group_periods,
                             actual_cap_group_periods)
        ...
        self.assertDictEqual(expected_prj_in_cap_group,
                             actual_prj_in_cap_group)
