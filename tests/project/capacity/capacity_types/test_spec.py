...
NAME_OF_MODULE_BEING_TESTED = \
    "project.capacity.capacity_types.spec"
...
class TestCapacityTypeSpec(unittest.TestCase):
    """
    ...
    def test_data_loaded_correctly(self):
        ...
        actual_specified_power_cap = OrderedDict(
            sorted(
                {(prj, period):
                    instance.spec_capacity_mw[prj, period]
                 for (prj, period) in
                 instance.
                    SPEC_OPR_PRDS
                 }.items()
        ...
        # Params: spec_energy_capacity_mwh
        expected_specified_energy_cap = OrderedDict(
            sorted(
                {("Nuclear", 2020): 0.0, ("Gas_CCGT", 2020): 0.0,
                 ("Coal", 2020): 0.0, ("Gas_CT", 2020): 0.0,
                 ("Wind", 2020): 0.0, ("Nuclear", 2030): 0.0,
                 ("Gas_CCGT", 2030): 0.0, ("Coal", 2030): 0.0,
                 ("Gas_CT", 2030): 0.0, ("Wind", 2030): 0.0,
                 ("Nuclear_z2", 2020): 0.0, ("Gas_CCGT_z2", 2020): 0.0,
                 ("Coal_z2", 2020): 0.0, ("Gas_CT_z2", 2020): 0.0,
                 ("Wind_z2", 2020): 0.0, ("Nuclear_z2", 2030): 0.0,
                 ("Gas_CCGT_z2", 2030): 0.0, ("Coal_z2", 2030): 0.0,
                 ("Gas_CT_z2", 2030): 0.0, ("Wind_z2", 2030): 0.0,
                 ("Hydro", 2020): 0.0, ("Hydro", 2030): 0.0,
                 ("Hydro_NonCurtailable", 2020): 0.0,
                 ("Hydro_NonCurtailable", 2030): 0.0,
                 ("Disp_Binary_Commit", 2020): 0.0,
                 ("Disp_Binary_Commit", 2030): 0.0,
                 ("Disp_Cont_Commit", 2020): 0.0, ("Disp_Cont_Commit", 2030): 0.0,
                 ("Disp_No_Commit", 2020): 0.0, ("Disp_No_Commit", 2030): 0.0,
                 ("Customer_PV", 2020): 0.0, ("Customer_PV", 2030): 0.0,
        ...
        actual_specified_energy_cap = OrderedDict(
            sorted(
                {(prj, period):
                    instance.spec_energy_capacity_mwh[prj, period]
                 for (prj, period) in
                 instance.
                    SPEC_OPR_PRDS
                 }.items()
        ...
        # Params: spec_fixed_cost_per_mw_yr
        expected_fixed_cost_per_mw = OrderedDict(
            sorted(
                {("Nuclear", 2020): 0.0, ("Gas_CCGT", 2020): 0.0,
                 ...
                 ("Battery_Specified", 2020): 10000.0}.items()
            )
        )
        actual_fixed_cost_per_mw = OrderedDict(
            sorted(
                {(prj, period):
                    instance.spec_fixed_cost_per_mw_yr[prj,
                                                                    period]
                 for (prj, period) in
                 instance.
                    SPEC_OPR_PRDS
        ...
        # Params: spec_fixed_cost_per_mwh_yr
        expected_fixed_cost_per_mwh = OrderedDict(
            sorted(
                {("Nuclear", 2020): 0.0, ("Gas_CCGT", 2020): 0.0,
                 ...
                 ("Customer_PV", 2020): 0.0, ("Customer_PV", 2030): 0.0,
                 ("Nuclear_Flexible", 2030): 0.0,
                 ("Battery_Specified", 2020): 5000.0}.items()
            )
        )
        actual_fixed_cost_per_mwh = OrderedDict(
            sorted(
                {(prj, period):
                    instance.spec_fixed_cost_per_mwh_yr[prj,
                                                                    period]
                 for (prj, period) in
                 instance.
                    SPEC_OPR_PRDS
