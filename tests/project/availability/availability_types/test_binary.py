...
NAME_OF_MODULE_BEING_TESTED = "project.availability.availability_types.binary"
...
class TestBinaryAvailabilityType(unittest.TestCase):
    """ """
    ...
    def test_data_loaded_correctly(self):
        ...
        # Set: AVL_BIN
        expected_project_subset = sorted(["Gas_CCGT"])
        actual_project_subset = sorted([prj for prj in instance.AVL_BIN])
        ...
        actual_operational_timepoints_by_project = sorted(
            [(g, tmp) for (g, tmp) in instance.AVL_BIN_OPR_TMPS]
        )
        ...
        actual_unavailable_hours_per_period = {
            prj: instance.avl_bin_unavl_hrs_per_prd[prj] for prj in instance.AVL_BIN
        }
