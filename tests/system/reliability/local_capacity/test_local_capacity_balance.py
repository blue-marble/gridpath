...
NAME_OF_MODULE_BEING_TESTED = "system.reliability.local_capacity.local_capacity_balance"
...
class TestLocalCapacityBalance(unittest.TestCase):
    """ """
    ...
    def test_data_loaded_correctly(self):
        ...
        expected_penalty = OrderedDict(
            sorted(
                {"Local_Capacity_Zone1": 10000, "Local_Capacity_Zone2": 10000}.items()
            )
        )
