...
NAME_OF_MODULE_BEING_TESTED = "system.reserves.aggregation.inertia_reserves"
...
class TestSpinningReservesAgg(unittest.TestCase):
    """ """
    ...
    def test_data_loaded_correctly(self):
        ...
        # Set: INERTIA_RESERVES_PROJECTS_OPERATIONAL_IN_TIMEPOINT
            ...
            sorted(
                {
                    tmp: sorted(
                        [
                            prj
                            for prj in instance.INERTIA_RESERVES_PROJECTS_OPERATIONAL_IN_TIMEPOINT[
                                tmp
                            ]
                        ]
                    )
