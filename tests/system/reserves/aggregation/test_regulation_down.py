...
NAME_OF_MODULE_BEING_TESTED = "system.reserves.aggregation.regulation_down"
...
class TestRegulationDownAgg(unittest.TestCase):
    """ """
            ...
            sorted(
                {
                    tmp: sorted(
                        [
                            prj
                            for prj in instance.REGULATION_DOWN_PROJECTS_OPERATIONAL_IN_TIMEPOINT[
                                tmp
                            ]
                        ]
                    )
