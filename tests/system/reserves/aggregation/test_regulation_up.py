...
NAME_OF_MODULE_BEING_TESTED = "system.reserves.aggregation.regulation_up"
...
class TestRegulationUpAgg(unittest.TestCase):
    """ """
            ...
            sorted(
                {
                    tmp: sorted(
                        [
                            prj
                            for prj in instance.REGULATION_UP_PROJECTS_OPERATIONAL_IN_TIMEPOINT[
                                tmp
                            ]
                        ]
                    )
