...
NAME_OF_MODULE_BEING_TESTED = "system.reserves.requirement.regulation_down"
...
class TestCosts(unittest.TestCase):
    ...
    def test_data_loaded_correctly(self):
        ...
        req_df = pd.read_csv(
            os.path.join(
                TEST_DATA_DIRECTORY, "inputs", "regulation_down_tmp_requirement.tab"
            ),
            sep="\t",
        )
        ...
        actual_ba_tmps = sorted(
            [(z, tmp) for (z, tmp) in instance.REGULATION_DOWN_ZONES * instance.TMPS]
        )
