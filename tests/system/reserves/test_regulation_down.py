...
PREREQUISITE_MODULE_NAMES = [
     ...
     "geography.load_zones", "geography.regulation_down_balancing_areas",
     "project", "project.capacity.capacity",
     "project.operations.reserves.regulation_down"]
NAME_OF_MODULE_BEING_TESTED = "system.reserves.regulation_down"
...
class TestRegulationDown(unittest.TestCase):
    """
        ...
        actual_projects = OrderedDict(sorted({
            tmp:
                sorted([prj for prj in
                        instance.
                        REGULATION_DOWN_PROJECTS_OPERATIONAL_IN_TIMEPOINT[tmp]
