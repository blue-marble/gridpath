...
PREREQUISITE_MODULE_NAMES = [
     ...
     "geography.load_zones", "geography.load_following_down_balancing_areas",
     "project", "project.capacity.capacity",
     "project.operations.reserves.lf_reserves_down"]
NAME_OF_MODULE_BEING_TESTED = "system.reserves.lf_reserves_down"
...
class TestLFReservesDown(unittest.TestCase):
    """
        ...
        actual_projects = OrderedDict(sorted({
            tmp:
                sorted([prj for prj in
                        instance.
                        LF_RESERVES_DOWN_PROJECTS_OPERATIONAL_IN_TIMEPOINT[tmp]
