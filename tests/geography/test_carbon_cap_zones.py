...
NAME_OF_MODULE_BEING_TESTED = "geography.carbon_cap_zones"
...
class TestCarbonCapZones(unittest.TestCase):
    """ """
    ...
    def test_data_loaded_correctly(self):
        ...
        expected_carbon_cap_zones = sorted(["Carbon_Cap_Zone1", "Carbon_Cap_Zone2"])
        actual_carbon_cap_zones = sorted([z for z in instance.CARBON_CAP_ZONES])
        self.assertListEqual(expected_carbon_cap_zones, actual_carbon_cap_zones)
