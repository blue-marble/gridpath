...
NAME_OF_MODULE_BEING_TESTED = "geography.regulation_up_balancing_areas"
...
class TestLoadFollowingDownBAs(unittest.TestCase):
    ...
    def test_regulation_up_zones_data_loads_correctly(self):
        """
        ...
        actual = sorted([z for z in instance.REGULATION_UP_ZONES])
        self.assertListEqual(
            expected,
            actual,
            msg="REGULATION_UP_ZONES set data does not " "load correctly.",
        )
        ...
        actual_allow_violation = OrderedDict(
            sorted(
                {
                    z: instance.regulation_up_allow_violation[z]
